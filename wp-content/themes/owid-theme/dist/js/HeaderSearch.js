...
var PostResult = /** @class */ (function (_super) {
    ...
    PostResult.prototype.render = function () {
        ...
        return React.createElement("div", { className: "PostResult" },
            React.createElement("a", { href: "/" + hit.slug, dangerouslySetInnerHTML: { __html: hit._highlightResult.title.value } }),
            React.createElement("p", { dangerouslySetInnerHTML: { __html: hit._highlightResult.content.value } }));
    };
    return PostResult;
}(React.Component));
