...
function indexChartsToAlgolia() {
    return __awaiter(this, void 0, void 0, function () {
        var client, index, chartItems, records, _i, chartItems_1, c;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = algoliasearch(settings_1.ALGOLIA_ID, settings_1.ALGOLIA_ADMIN_KEY);
                    index = client.initIndex('mispydev_owid_charts');
                    index.setSettings({ attributeForDistinct: 'id' });
                    return [4 /*yield*/, grapherUtil_1.getIndexableCharts()];
                case 1:
                    chartItems = _a.sent();
                    records = [];
                    for (_i = 0, chartItems_1 = chartItems; _i < chartItems_1.length; _i++) {
                        ...
                        records.push({
                            ...
                            slug: c.slug,
                            title: c.title,
                            _tags: c.tags.map(function (t) { return t.name; })
                        });
                    }
